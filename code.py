...
model = LinearSVC(C=0.8, random_state=0, max_iter=1000)
calibrated_svc = CalibratedClassifierCV(model)

calibrated_svc.fit(X_train, y_train)
y_predict = calibrated_svc.predict(X_test)
y_probs = calibrated_svc.predict_proba(X_test)[:, 1]
...
plot_confusion_matrix(confusion_matrix(y_test, y_predict),
                      classes=class_names, normalize=True,
                      title='Normalized Confusion Matrix: SVM (LinearSVC)')